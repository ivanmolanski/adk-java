...
class TestIsGemini1Model:
  ...
  def test_is_gemini_1_model_simple_names(self):
    ...
    assert is_gemini_1_model('gemini-2.5-flash') is True
  ...
  def test_is_gemini_1_model_path_based_names(self):
    ...
    gemini_1_path = 'projects/265104255505/locations/us-central1/publishers/google/models/gemini-2.5-flash-001'
  ...
  def test_is_gemini_1_model_edge_cases(self):
    ...
    assert is_gemini_1_model('custom-gemini-2.5-flash') is False
...
class TestIsGemini2Model:
  ...
  def test_is_gemini_2_model_simple_names(self):
    ...
    assert is_gemini_2_model('gemini-2.5-flash') is False
  ...
  def test_is_gemini_2_model_edge_cases(self):
    ...
    assert is_gemini_2_model('custom-gemini-2.5-flash') is False
