          ...
          <CardContent>
            <div className="space-y-4">
              {trends?.slice(0, 4).map((trend, index) => (
                <div key={trend.id ?? `trend-${index}`} className="flex items-center space-x-4 p-4 border rounded-lg hover:bg-gray-50">
          ...
          <CardContent>
            <div className="space-y-4">
              {drafts?.slice(0, 4).map((draft, index) => (
                <div key={draft.id ?? `draft-${index}`} className="p-4 border rounded-lg hover:bg-gray-50">
